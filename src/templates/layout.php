...
<head>
    ...
    <link rel="stylesheet" href="/css/dynamicContent.css">
...
<body>
    <header>
        ...
        <div id="header-div-profile">
            ...
            <div id="profile-menu" class="hidden">
                <a href="/profile">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-round-icon lucide-user-round">
    ...
    <nav>
        <button class="btn-icon active" onclick="loadDashboardContent('home')">
            <span class="icon" aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-diamond-plus-icon lucide-diamond-plus">
                    <path d="M12 8v8" />
        ...
        <button class="btn-icon" aria-label="Usuarios" onclick="loadDashboardContent('expenses')">
            <span class="icon" aria-hidden="true">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-diamond-minus-icon lucide-diamond-minus">
                    <path d="M2.7 10.3a2.41 2.41 0 0 0 0 3.41l7.59 7.59a2.41 2.41 0 0 0 3.41 0l7.59-7.59a2.41 2.41 0 0 0 0-3.41L13.7 2.71a2.41 2.41 0 0 0-3.41 0z" />
                    <path d="M8 12h8" />
                </svg>
            </span>
    ...
    <script type="module" src="/js/expenses.js" defer></script>
</body>
